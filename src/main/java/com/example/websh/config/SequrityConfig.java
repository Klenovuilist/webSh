...
//                                .requestMatchers(HttpMethod.GET,"/api/login/**").permitAll()
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/authorize_user/**").permitAll()
...
//                        new LoginUrlAuthenticationEntryPoint("/api/login/"))) // переадресация на адрес если ошибка аутентификации(аутентифик..не выполнена)
